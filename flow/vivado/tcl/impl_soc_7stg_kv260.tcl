# ==========================================
# impl_soc_7stg_kv260.tcl
# Implement riscv_soc_7stg on KV260 fabric.
# No board pin constraints; timing uses clock-only constraint.
# ==========================================

set part_name "xck26-sfvc784-2LV-c"
set top_name  "riscv_soc_7stg"
set rpt_root  "reports/soc_7stg_kv260_impl"

# Optional:
#   vivado -mode batch -source ../tcl/impl_soc_7stg_kv260.tcl -tclargs 5.500
...
report_utilization -hierarchical -file $rpt_dir/util_synth_hier.rpt
report_utilization -file $rpt_dir/util_synth.rpt
report_timing_summary -file $rpt_dir/timing_synth.rpt
report_ram_utilization -file $rpt_dir/ram_synth.rpt
...
# Post-route reports
report_utilization -hierarchical -file $rpt_dir/util_impl_hier.rpt
report_utilization -file $rpt_dir/util_impl.rpt
report_timing_summary -file $rpt_dir/timing_impl.rpt
report_route_status -file $rpt_dir/route_status.rpt
report_ram_utilization -file $rpt_dir/ram_impl.rpt
report_design_analysis -timing -file $rpt_dir/design_analysis_timing.rpt

puts "=== Implementation complete: $top_name on $part_name ==="
