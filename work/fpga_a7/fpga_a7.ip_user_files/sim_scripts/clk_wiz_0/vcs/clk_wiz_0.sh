...
#
# Script generated by Vivado on Sat Jun 13 15:57:03 +07 2026
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic" +incdir+"../../../../../Data/Vivado/2025.2/data/rsb/busdef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic" +incdir+"../../../../../Data/Vivado/2025.2/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/quocviet/fpga_a7/fpga_a7.cache/compile_simlib/vcs"
  fi
