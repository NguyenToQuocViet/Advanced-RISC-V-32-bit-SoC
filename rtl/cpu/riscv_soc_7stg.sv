...
// Module       : riscv_soc_7stg
// Description  : 7-stage SoC wrapper connecting riscv_core_7stg and
//                cache_subsystem_7stg. Exposes an AXI4 master port.
//
...
(
    ...
    //7-stage core
    riscv_core_7stg u_riscv_core_7stg (
        .clk              (clk),
        .rst_n            (rst_n),
        .if_req           (if_req),
        .if_pc            (if_pc),
    ...
    cache_subsystem_7stg u_cache_subsystem_7stg (
        .clk              (clk),
        .rst_n            (rst_n),
        .if_pc            (if_pc),
        .if_req           (if_req),
